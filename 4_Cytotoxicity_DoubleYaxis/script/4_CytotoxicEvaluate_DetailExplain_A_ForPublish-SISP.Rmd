...
2.  `log10_Concentration_pM` = Concentration of the drug (μM)\
...
5.  `Replicate` = Technical replicate of the experiment\
  ...
  Here, we also provide [a set of example inputs](https://github.com/KuchikiNamthip/3D-SiSP/tree/main/4_Cytotoxicity_DoubleYaxis/input), where each `WellName.csv` file contains information about the spheroids in the respective well. \
