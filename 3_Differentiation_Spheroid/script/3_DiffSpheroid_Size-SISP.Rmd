...
## 2. Inputs
  ...
  As an example, two of `.csv` files were provided [a set of example inputs](https://github.com/KuchikiNamthip/3D-SiSP/tree/main/3_Differentiation_Spheroid/input), where each `.csv` file contains information about the objects in the respective labeling. \
